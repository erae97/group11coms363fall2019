<%
	...
	String DB_URL = "jdbc:mysql://localhost:3306/cs363teamproject?useSSL=false";
	String DB_USERNAME = "test"; // update to use your non-root password
	String DB_PASSWORD="test";	// replace with the password for the user
%>
